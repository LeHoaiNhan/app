// ISO 3166-1 list of countries — used for nationality and passport-issuing
// country dropdowns. Not the same as the destination Country DB (which holds
// only countries we *sell visas for*).
// Subset of common nationalities — keep alphabetical, edit freely.
...
export const findNationalityByName = (name) =>
  NATIONALITIES.find(n => n.name.toLowerCase() === String(name || '').toLowerCase())

export const findNationalityByIso = (iso) =>
  NATIONALITIES.find(n => n.iso === String(iso || '').toLowerCase())
