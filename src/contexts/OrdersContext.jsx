...
const SEED_ORDERS = [
  {
    ...
    applicant: {
      fullName: 'John Smith', email: 'john.smith@gmail.com', phone: '+1 415 555 0101',
      dob: '1995-03-12', gender: 'Male', nationality: 'United States', birthPlace: 'San Francisco, USA',
      photoURL: 'https://ui-avatars.com/api/?name=John+Smith&background=1B4FD8&color=fff&size=200',
    },
    passport: {
      no: 'B1234567', type: 'Regular passport',
      issueDate: '2020-01-15', expiryDate: '2030-01-14',
      issuePlace: 'San Francisco Passport Agency', issueCountry: 'United States',
    },
    trip: {
      purpose: 'Tourism', entryDate: '2026-06-15', exitDate: '2026-06-25',
  ...
  },
  {
    ...
    trip: {
      purpose: 'Tourism', entryDate: '2026-04-01', exitDate: '2026-04-10',
  ...
  },
  {
    ...
    applicant: {
      fullName: 'Emma Johnson', email: 'emma.johnson@gmail.com', phone: '+44 20 7946 0102',
      dob: '1992-07-23', gender: 'Female', nationality: 'United Kingdom', birthPlace: 'London, UK',
      photoURL: 'https://ui-avatars.com/api/?name=Emma+Johnson&background=F59E0B&color=fff&size=200',
    },
  ...
  },
  {
    ...
    applicant: {
      fullName: 'Michael Brown', email: 'michael.brown@yahoo.com', phone: '+1 212 555 0103',
      dob: '1988-11-05', gender: 'Male', nationality: 'United States', birthPlace: 'New York, USA',
      photoURL: 'https://ui-avatars.com/api/?name=Michael+Brown&background=10B981&color=fff&size=200',
    },
  ...
  },
  {
    ...
    applicant: {
      fullName: 'David Wilson', email: 'david.wilson@gmail.com', phone: '+61 2 5550 0104',
      dob: '1990-02-28', gender: 'Male', nationality: 'Australia', birthPlace: 'Sydney, Australia',
      photoURL: 'https://ui-avatars.com/api/?name=David+Wilson&background=DC2626&color=fff&size=200',
    },
  ...
  },
  {
    ...
    applicant: {
      fullName: 'Sophie Martin', email: 'sophie.martin@gmail.com', phone: '+33 1 5550 0105',
      dob: '1996-09-15', gender: 'Female', nationality: 'France', birthPlace: 'Paris, France',
      photoURL: 'https://ui-avatars.com/api/?name=Sophie+Martin&background=9333EA&color=fff&size=200',
    },
  ...
  },
  {
    ...
    applicant: {
      fullName: 'Andreas Schmidt', email: 'andreas.schmidt@gmail.com', phone: '+49 30 5550 0106',
      dob: '1985-05-30', gender: 'Male', nationality: 'Germany', birthPlace: 'Munich, Germany',
      photoURL: 'https://ui-avatars.com/api/?name=Andreas+Schmidt&background=059669&color=fff&size=200',
    },
  ...
  },
  {
    ...
    applicant: {
      fullName: 'Olivia Davis', email: 'olivia.davis@yahoo.com', phone: '+1 312 555 0107',
      dob: '1993-08-12', gender: 'Female', nationality: 'United States', birthPlace: 'Chicago, USA',
      photoURL: 'https://ui-avatars.com/api/?name=Olivia+Davis&background=F5A623&color=fff&size=200',
    },
  ...
  },
  {
    ...
    applicant: {
      fullName: 'James Anderson', email: 'james.anderson@gmail.com', phone: '+1 617 555 0108',
      dob: '1980-12-22', gender: 'Male', nationality: 'United States', birthPlace: 'Boston, USA',
      photoURL: 'https://ui-avatars.com/api/?name=James+Anderson&background=1B4FD8&color=fff&size=200',
    },
...
export function OrdersProvider({ children }) {
  ...
  const createOrder = (data) => {
    ...
    const order = {
      id,
      status: 'submitted',
      timeline: [{ stage: 'submitted', at: now, note: 'Application received, payment successful' }],
      createdAt: now,
      updatedAt: now,
      ...data,
    }
